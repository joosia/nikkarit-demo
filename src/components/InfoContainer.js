...
const InfoContainer = ({ infoContainerData }) => {
    return (
        <Row className="shadow-sm py-2 my-3 bg-white">
            ...
            <Col>
                <Row className="my-2">
                    <Col className="align-items-center"><i className="fas fa-chevron-left"></i><span className="mx-1 h4 font-weight-bold">2019</span><i className="fas fa-chevron-right"></i></Col>
